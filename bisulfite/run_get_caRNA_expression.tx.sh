...
#BSUB -W 48:00
#BSUB -J run_get_caRNA_expression.tx
#BSUB -P run_get_caRNA_expression.tx
#BSUB -N
#BSUB -oo /research_jude/rgs01_jude/groups/tatevgrp/home/kzhou/project/chen_yang_lab/ying_qing/tet1/bisulfite_seq/inhouse_data/log/run_get_caRNA_expression.tx.log
#BSUB -eo /research_jude/rgs01_jude/groups/tatevgrp/home/kzhou/project/chen_yang_lab/ying_qing/tet1/bisulfite_seq/inhouse_data/log/run_get_caRNA_expression.tx.err
...
## caRNA-batch1
BAM_DIR="$BASE/alignment_unconverted/caRNA/batch1"
OUTPUT_DIR="$BASE/analysis/DESeq2/caRNA_tx/batch1"
...
run_get_exp $BAM_DIR $OUTPUT_DIR caRNA_tx $GTF "transcript_id"


## caRNA-batch2
BAM_DIR="$BASE/alignment_unconverted/caRNA/batch2"
OUTPUT_DIR="$BASE/analysis/DESeq2/caRNA_tx/batch2"
GTF="$BASE/annotation/hg38.gencode.v37.annotation.caRNA.gtf"
